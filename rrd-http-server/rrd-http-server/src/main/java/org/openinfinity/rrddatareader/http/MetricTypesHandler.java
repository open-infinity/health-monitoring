...
public class MetricTypesHandler implements AbstractHandler {
    ...
    public void handle(HttpResponse response, QueryStringDecoder queryStringDecoder) throws Exception {
        ...
        response.setContent(ChannelBuffers.copiedBuffer(monitoringService.getMetricTypes(hostName).getBytes()));
    }
}
