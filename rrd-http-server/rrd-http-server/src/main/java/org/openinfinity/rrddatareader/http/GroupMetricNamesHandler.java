...
public class GroupMetricNamesHandler implements AbstractHandler {
    ...
    public void handle(HttpResponse response, QueryStringDecoder queryStringDecoder) throws Exception {
        ...
        response.setContent(ChannelBuffers.copiedBuffer(monitoringService.getGroupMetricNames(groupName,
                metricType).getBytes()));
    }
}
