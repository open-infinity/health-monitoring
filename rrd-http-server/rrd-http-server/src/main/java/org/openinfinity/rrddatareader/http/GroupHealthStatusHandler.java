...
public class GroupHealthStatusHandler implements AbstractHandler {
    ...
    public void handle(HttpResponse response, QueryStringDecoder queryStringDecoder) throws Exception {
        ...
        response.setContent(ChannelBuffers.copiedBuffer(monitoringService.getGroupHealthStatus(groupName, dataType,
